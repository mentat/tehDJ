...
#
SOURCE=..\..\pa_tests\patest_record.c
LINK32_OBJS= \
	"$(INTDIR)\patest_record.obj"

"$(INTDIR)\patest_record.obj" : MAKEOBJ
...
!ENDIF
	-@erase "$(INTDIR)\patest_record.obj"
...
#"$(INTDIR)\patest_record.obj" : $(SOURCE) "$(INTDIR)"
#	$(CPP) $(CPP_PROJ) $(SOURCE)
