...
#
SOURCE=..\..\pa_tests\patest_dither.c
LINK32_OBJS= \
	"$(INTDIR)\patest_dither.obj"

"$(INTDIR)\patest_dither.obj" : MAKEOBJ
...
!ENDIF
	-@erase "$(INTDIR)\patest_dither.obj"
...
#"$(INTDIR)\patest_dither.obj" : $(SOURCE) "$(INTDIR)"
#	$(CPP) $(CPP_PROJ) $(SOURCE)
